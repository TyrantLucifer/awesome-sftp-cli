...
**Current checkpoint**: foundation SHA `ae172d9bb419bc6b0b05cf3ef3467258496d463f`, doctor SHA `7aa6f20d1cada28064cfd4f169442ef219a9b1a8`, and support-bundle SHA `bfc59c8c0478a7043b8287f52d31dd3477b30554` deliver the shared sensitivity policy, fixed safe doctor, public preview/create, reviewed eight-source composition, consent drift refusal, and private durable publication. Evidence SHA `496356908990d4bb5d9473acad754fd8ae7217ca` completed push/PR with 22 success / 1 known Helper visibility failure / 1 dependency-skipped each; the Ubuntu 22.04 stderr-overflow and macOS ARM heartbeat failures each passed in the same-SHA opposite workflow, and changed packages passed inside both failed jobs, so no rerun occurred. Hardening SHA `ba334b8d8968f5b09c91c0185996994b9a307ff4`, tree `1725549ade259b172f41af66d52dc2319a583fa8`, adds semantic registries for persistent diagnostics, per-domain validation for every exported structured string, an eight-class safe-shaped corpus scan over persistent JSON and expanded archives, and corrupt config/database/cache/daemon byte-preservation plus stable-code summaries. Focused normal/race/vet, exact current Go 1.26.5 `make ci`, and exact oldstable Go 1.25.12 `make check` pass. Actual auth-artifact/Helper scans, native compatibility, troubleshooting, and threat/finding ledgers remain open.

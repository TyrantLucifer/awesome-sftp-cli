...
**Current checkpoint**: foundation, doctor, support-bundle, semantic hardening, compatibility/troubleshooting, threat model, and initial finding ledger are delivered. Real-auth correction SHA `fd5ebe499331f5697cdc5eb1e238d12e939ee53a` has dual-workflow support-bundle scan evidence after complete OpenSSH/Askpass and externally renewed Kerberos/GSSAPI matrices. OpenSSH-floor/current SHAs `e7733ec23ec1903dbdc41a926db20fe6defcccc7`/`a7f3ddd8a99df973518140de7eae45e295ae6ea2` and Kerberos-binding SHA `14e5ec4e63c70fb93ed93d15adbe7fdf7cce5d5e` pass exact current/oldstable local gates. REL-007 SHA `cc6559e41572aa21a7fc249fe0086fe4df50fe27` covers all eight required security/fault domains with executable negative evidence. The current REL-011/012 batch closes residual control-Socket reachability without weakening fail-closed startup: a validated private Unix Socket is considered absent only when its canonical instance lock is definitively not live; status performs no cleanup, while the daemon must acquire the matching lock and revalidate before unlink/bind. Live/uncertain locks and non-Socket/symlink/unsafe paths remain errors. PLAT-009 is `Verified`; REL-006, REL-007, REL-011, and REL-012 remain `In Progress`. Production-Helper artifact scans, published rollback, and final independent review remain open.

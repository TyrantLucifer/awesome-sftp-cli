...
**Current checkpoint**: deterministic packaging `958dec07addbe12c0c02404af4baf90558286909` and dependency/SBOM `99db0e822b80d01519191e9bd13a894794c018c2` each passed exact-SHA push/PR Hosted 24/24. Installed lifecycle evidence SHA `d625a677f59e6e21d55516d2533db34c43d516fa` push passed 24/24 including the exact full lifecycle; PR's sole failure was initial Stage 5 readiness timing and is contradicted by the same-SHA complete push. Public Helper commit `49f39401c1693a92917a77efae1ab0a41175237b` exposes install/upgrade syntax, literal stable-home consent, pre-runtime rejection of arbitrary artifact/manifest/path inputs, stable human/JSON closed-distribution errors, and help/man/completion parity. Current full `make ci`, exact oldstable full `make check`, and exact clean CLI/fresh-HOME no-mutation smoke pass; Helper batch Hosted remains. Native/channel, final license/notices, signing/notary, real Helper composition and Level 2 remain open.

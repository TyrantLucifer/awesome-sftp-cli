...
- **Status**: In Progress — M6.1 complete; M6.2 migration, retention, Helper lifecycle, deterministic packaging/dependencies, native lifecycle, preview-archive picker, pinned-cache recovery, and reviewed third-party NOTICE evidence active
- **Updated**: 2026-07-18
...
**Current checkpoint**: deterministic packaging/dependency closure, installed lifecycle, public Helper surface, release source, owner composition, four-platform native lifecycle, preview-archive picker, and pinned-cache recovery have exact-SHA evidence while production trust remains empty. Reviewed third-party NOTICE SHA `197ff6f12135be670df40bd5f0dfe7e8c72fe483` covers every declared runtime module exactly once, preserves replacement-resolved identity, binds all reviewed redistribution bytes, and packages the regenerated byte-identical NOTICE in CI. Exact current/oldstable local gates and both Hosted NOTICE/packaging paths pass. Public-channel execution, the owner-selected project LICENSE, signing/notary, protected production Helper and Level 2 remain open.

**Latest increment**: implementation SHA `197ff6f12135be670df40bd5f0dfe7e8c72fe483`, tree `e1d203edcb820c332a98650cd6256bf6f5872a43`, passed exact current Go 1.26.5 `make ci` and exact oldstable Go 1.25.12 `make check`. Push [29641186074](https://github.com/TyrantLucifer/awsome-sftp-cli/actions/runs/29641186074) finished 22 success / 1 failure / 1 dependency-skipped; PR [29641186949](https://github.com/TyrantLucifer/awsome-sftp-cli/actions/runs/29641186949) finished 21 success / 1 failure / 2 dependency-skipped. Push quality completed the full lifecycle. PR quality generated, byte-compared and packaged the NOTICE before the frozen Stage 5 daemon missed the existing readiness poll. Push native macOS Intel alone hit the existing exact-stderr-cap visibility race while the PR Intel companion passed. No rerun or weakening occurred. This technically closes the reviewed third-party NOTICE, not the project LICENSE, real public channel, or final release trust.

...
**Current checkpoint**: foundation, doctor, support-bundle, semantic hardening, compatibility/troubleshooting, threat model, and initial finding ledger are delivered. Real-auth correction SHA `fd5ebe499331f5697cdc5eb1e238d12e939ee53a` has dual-workflow exact-SHA support-bundle scan evidence after complete OpenSSH/Askpass and externally renewed Kerberos/GSSAPI matrices. OpenSSH-floor SHA `e7733ec23ec1903dbdc41a926db20fe6defcccc7`, tree `eb18a732c3cc82a5224b4f5c0decf135c40cc9d4`, passes exact current/oldstable local gates. Its push/PR Ubuntu 22.04 native jobs `88099968231`/`88099973802` both record `OpenSSH_8.9p1 Ubuntu-3ubuntu0.16`, then pass public doctor OpenSSH/endpoint checks, complete authentication, and the real support-bundle scan; production runtime has no version-string hard rejection. The three residual macOS failures across push `29652064203` and PR `29652066243` are existing PTY-selection/Helper-heartbeat timing with exact same-SHA successful companions; no rerun occurred. PLAT-009 is `In Progress` pending exact current-version capture and final support-document closure. Production-Helper artifact scans and final independent review remain open.

...
**Current checkpoint**: foundation, doctor, support-bundle, semantic hardening, compatibility/troubleshooting, threat model, and initial finding ledger are delivered. Evidence SHA `6653a617045b1ed0c03c5b297dbcbd38db27116d` passed PR 24/24. Initial auth-artifact Hosted SHA `00ca5d8ecf5f4ab47d7150f3dbaf17163678fb80` exposed that login-home output was rejected by the public persistent-private publication boundary after the complete OpenSSH/Askpass matrix. Correction SHA `fd5ebe499331f5697cdc5eb1e238d12e939ee53a`, tree `6415e2d189727652617f6c931a74500a88df2067`, moves only the scan artifact root to the existing 0700 `XDG_STATE_HOME`; focused and dual-Go full local gates pass. PR `29651141681` passed 24/24. Push `29651140328` retained two existing macOS Helper timing failures with exact same-SHA PR companions, while push/PR auth jobs `88098085447`/`88098124518` both passed and each log contains exactly two scan-pass markers after the full OpenSSH/Askpass and externally renewed Kerberos/GSSAPI matrices. Production-Helper artifact scans and final independent review remain open.

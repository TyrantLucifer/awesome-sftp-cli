...
Stage 3 works without a remote Helper. Recursive filename/content search, Helper install/handshake/fast walk/hash/watch/tail, cross-host direct/server-side copy, release packaging/signing/notarization, and full scale/release readiness remain Stage 4–6 work. Production Helper distribution remains **CLOSED** until the documented production private-key custody and release ceremony exist; test public-key fixtures do not authorize distribution.

...
| sqlite state | 3 | `939ba9c5d978b8ea5bf1ae060ff62a0769d0d6c0` | capture-required-before-M6.2-mutation | `internal/compatibility/testdata/historical/sqlite-v3-stage3.sqlite` | `-` | `internal/state/migration` |

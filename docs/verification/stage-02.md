...
- **Current action**: close sidecar/bootstrap crash fixtures, replace the same-process capability probe with the required same-binary cross-process probe, and finish failure-boundary recovery evidence.

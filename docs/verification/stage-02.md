...
- **Open gate**: real user-visible local and temporary-sshd MVP transcripts, broader disconnect/permission/disk-full/commit-response/crash evidence, recent-error/recovery detail in the Jobs view, and exact-candidate Hosted execution remain required before M2.2 can be marked complete.

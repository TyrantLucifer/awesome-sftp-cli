...
- **Current action**: run the new explicit native ext4 and loop-mounted XFS persistent-state gate, then audit the remaining single-writer and fail-closed fixtures before closing M2.1.

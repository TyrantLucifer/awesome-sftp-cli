...
- M6.1 is complete. M6.2 and M6.3 have the independently classified migration, packaging, native, diagnostics, compatibility, OpenSSH/Kerberos, and security-review evidence recorded in the live ledger. M6.4 REL-008/REL-009 are `In Progress`: the user/operations path and exact-candidate gate-record contract exist, while no RC record or protected final-release evidence exists and all 12 stage exit criteria remain open.

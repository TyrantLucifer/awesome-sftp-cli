...
Stage 0–1 已完成；Stage 2 已进入 In Progress，Stage 3–6 保持 Not Started。Stage 2 的 ADR-0008 精确 SQLite 依赖准入和 M2.1 schema/backup/retention/WAL/upgrade coordinator 基础已完成；当前继续关闭 same-binary cross-process probe 与 native crash/recovery 门禁，M2.2 仍不得提前开始。

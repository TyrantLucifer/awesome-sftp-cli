...
**Current checkpoint**: 唯一基线仍为 `312bcccbcbd54246bbe5ff9babf4f14560449176`、tree `e0316c286ce11512cb0b92c917fa29b80f9e3305`。M6.1 已完成；M6.2 的 migration/package/native/preview Homebrew 独立切片已有 exact-SHA 证据，真实 public channel、项目 LICENSE 与 final protected bytes 仍开放。M6.3 real-auth scan SHA `fd5ebe499331f5697cdc5eb1e238d12e939ee53a` 已有 dual-workflow 证据。OpenSSH floor SHA `e7733ec23ec1903dbdc41a926db20fe6defcccc7`、tree `eb18a732c3cc82a5224b4f5c0decf135c40cc9d4` 通过 exact current Go 1.26.5 `make ci` 与 exact oldstable Go 1.25.12 `make check`；push/PR Ubuntu 22.04 native job `88099968231`/`88099973802` 均精确记录 `OpenSSH_8.9p1 Ubuntu-3ubuntu0.16`，随后 public doctor、完整认证和 support-bundle scan 全绿。push `29652064203` 的两个 oldstable macOS PTY selection failure 与 PR `29652066243` 的一个 native macOS Helper heartbeat failure 均为既有 timing，且各有 exact same-SHA opposite-workflow 成功 companion；未重跑。PLAT-009 进入 `In Progress`，current OpenSSH 精确版本留档与 final support docs 仍待。production-Helper artifact 扫描与 final review 仍开放；12 个 Stage 6 退出条件仍全部开放，production Helper distribution 与 production Level 2 保持 **CLOSED**。

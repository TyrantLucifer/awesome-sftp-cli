...
**Current checkpoint**: 唯一基线仍为 `312bcccbcbd54246bbe5ff9babf4f14560449176`、tree `e0316c286ce11512cb0b92c917fa29b80f9e3305`。M6.1 已完成；M6.2 的 migration/package/native/preview Homebrew 独立切片已有 exact-SHA 证据，真实 public channel、项目 LICENSE 与 final protected bytes 仍开放。M6.3 real-auth scan SHA `fd5ebe499331f5697cdc5eb1e238d12e939ee53a` 已有 dual-workflow 证据。OpenSSH floor/current SHA `e7733ec23ec1903dbdc41a926db20fe6defcccc7`/`a7f3ddd8a99df973518140de7eae45e295ae6ea2` 均通过 exact current Go 1.26.5 `make ci` 与 exact oldstable Go 1.25.12 `make check`，双工作流分别精确记录 `OpenSSH_8.9p1 Ubuntu-3ubuntu0.16` 与 `OpenSSH_9.6p1 Ubuntu-3ubuntu13.18`，并通过 version-bound public doctor、完整认证、support-bundle 与 Kerberos/GSSAPI gates。current PR `29652956741` 24/24；push `29652955122` 唯一 Ubuntu 24.04 config-expansion fixture failure 有 exact same-SHA PR 成功 companion，未重跑。PLAT-009 已 `Verified`。production-Helper artifact 扫描与 final review 仍开放；12 个 Stage 6 退出条件仍全部开放，production Helper distribution 与 production Level 2 保持 **CLOSED**。

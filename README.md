...
> [!WARNING]
> `v0.1.4` 是当前公开预览版本线。macOS 产物未经签名或公证，它不是公开的 AMSFTP 1.0；标准 Level 0 SFTP 路径可用，production Helper 和 Level 2 跨主机直传仍为 **CLOSED**。
...
公开预览发布页：[`v0.1.4`](https://github.com/TyrantLucifer/awesome-sftp-cli/releases/tag/v0.1.4)。历史 owner-only 内部预览仍可通过 Git 历史与旧 tag 追溯。

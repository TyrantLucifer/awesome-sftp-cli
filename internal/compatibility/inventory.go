...
func HistoricalSources() []HistoricalSource {
	return []HistoricalSource{
		...
		{Boundary: "sqlite state", Version: "3", ProvenanceCommit: "939ba9c5d978b8ea5bf1ae060ff62a0769d0d6c0", Status: HistoricalSourceCaptureRequired, Fixture: "internal/compatibility/testdata/historical/sqlite-v3-stage3.sqlite", Owner: "internal/state/migration"},
